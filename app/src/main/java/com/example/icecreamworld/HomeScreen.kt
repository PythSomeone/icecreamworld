    ...
    Box(modifier = Modifier
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally, modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.SpaceEvenly) {
            ...
            verticalArrangement = Arrangement.Bottom){
                HomeScreenButton(text = "Guest", navController = navController, route = "ProposedPage")
                HomeScreenButton(text = "Add your ICS", navController = navController, route = "AddShopScreen")
                HomeScreenButton(text = "Admin", navController = navController, route = "ManagementPage")
            }
        }
    }
}
